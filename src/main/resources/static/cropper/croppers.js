...
layui.config({
    ...
    var $ = layui.jquery
        ,layer = layui.layer;
    var html = "<link rel=\"stylesheet\" href=\"/cropper/cropper.css\">\n" +
        ...
        "        </div>\n" +
        "        <div class=\"layui-form-mid layui-word-aux\">自动裁剪尺寸为650x650px</div>\n" +
        "    </div>\n" +
        ...
        "            <div class=\"img-preview\" style=\"width:150px;height:200px;overflow:hidden\">\n" +
        "            </div>\n" +
        "        </div>\n" +
        "    </div>\n" +
        "    <div class=\"layui-row layui-col-space15\">\n" +
        ...
        "            <button class=\"layui-btn layui-btn-fluid\" cropper-event=\"confirmSave\" type=\"button\"> 上传图片</button>\n" +
        "        </div>\n" +
        "    </div>\n" +
        "\n" +
        "</div>";
